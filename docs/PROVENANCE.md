...
制作記録には、9/23記録の9枚と、別途掲載を許可された9/24の途中写真7枚を収録しています。
...
文字試作・台座・前面部品と、顔下部の途中の実写真・本人報告は[制作記録](BUILD-LOG.md)にあります。
現物の正確な寸法、keeper保持力、強度、転倒、P1Sの交換手順等の正式な評価結果は未提供です。
9/22の0.2 mmノズル申告、9/23の手応え・土台組立、9/24の顔下部の途中記録は、
使用した版のhash照合や模型全体の実証とは分けています。写真の色と設計色は別で、印刷データは変更していません。
