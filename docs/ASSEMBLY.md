...
**実制作の進捗：** 9/23の台座・前面に続き、2026-09-24に
[顔下部の組立途中の写真7枚](BUILD-LOG.md#progress-2026-09-24)を追記しました。
以下は設計に基づく組立案内です。写真から正確な段数、接着の有無や保持力を認定したものではありません。
上部ゴーグル・頭頂・全体完成の写真はまだ提供されていません。
写真で見える紫・黄色と、設計のマゼンタ・緑は区別します。配置・設計色は変更していません。
