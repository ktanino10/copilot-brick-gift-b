...
個人銘板は`NP3-TEXT-B`の1枚、**142 × 40 × 3.2 mm**、
黒の支持体2.4 mm＋白レリーフ0.8 mmです。
...
完成品は**150個、191.8 × 79.8 × 238.6 mm、黒台座5段48 mm**のままです。
fit試験片と7個の試作セットは別区分です。試作の2×2ブロック2個は完成BOMに含まれません。
他の試作良品は部品ID・色・必要数を確認して流用し、重複印刷を避けます。

## デジタルの案内と実物の安全を分ける

すべて**NOT_SLICED**。実機の嵌合、保持、強度、転倒、途中色替えは未試験です。
0.4／0.2 mmノズルはbaselineで、実ノズル、PLA、plate、profileは本人が確認します。
